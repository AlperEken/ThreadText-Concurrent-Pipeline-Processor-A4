...
public class MainPanel extends JPanel {
    ...
    {
        taDest.setText(""); // Rensar destinationrutan varje gång man klickar på Find and Replace
    ...
    public void markWord(String findString) {
        try {
            ...
            highlighter.removeAllHighlights(); // Rensa gamla markeringar
    ...
    // Visar originaltext i vänstra rutan
    public void setOriginalText(List<String> lines) {
        taSource.setText("");
        for (String str : lines) {
            taSource.append(str + "\n");
        }
    ...
    // Visar redigerad text i högra rutan
    public void setEditedText(List<String> lines) {
        taDest.setText("");
        for (String str : lines) {
            taDest.append(str + "\n");
        }
    ...
    {
        controller.loadFileOnlyforTest();
    }
}
